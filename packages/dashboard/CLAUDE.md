...
## Veyr spend status
> Auto-updated by Veyr · 2026-07-23 14:07 · disable in Veyr settings

**Current session:** claude-opus-4-8 · $7.8200/session · $0.0320/min
**Cache hit rate:** 100%

**Recommendations:**
- Run /compact — Session has cost $7.82 so far. Running /compact trims accumulated context before it grows further.
...
**Agent instructions:** You are currently in a Veyr-monitored session. Session cost so far: $7.82 at $0.032/min on claude-opus-4-8. Cache hit rate is 100% — good. Keep system prompts stable. This session is long and expensive. Run /compact now to compress context and reduce per-turn cost by ~60%. This is a long conversation. Before your next response, consider running /compact to compress context and reduce per-turn cost.
<!-- veyr:spend-status:end -->

<!-- veyr:graph-context:begin -->
## Veyr codebase graph
> Powered by Graphify · Full graph · 2026-07-23 14:07

### Architecture
3287 files, 45577 symbols in 1379 communities. Primary languages: Swift, Rust, TypeScript. Highest-impact code: .logger(), L(), tauri.ts.
