...
## Veyr spend status
> Auto-updated by Veyr · 2026-07-22 00:28 · disable in Veyr settings

**Current session:** claude-fable-5 · $36.7700/session · $0.1070/min
**Cache hit rate:** 100%
...
**Agent instructions:** You are currently in a Veyr-monitored session. Session cost so far: $36.77 at $0.107/min on claude-fable-5. Cache hit rate is 100% — good. Keep system prompts stable. This session is long and expensive. Run /compact now to compress context and reduce per-turn cost by ~60%. This is a long conversation. Before your next response, consider running /compact to compress context and reduce per-turn cost.
<!-- veyr:spend-status:end -->

<!-- veyr:graph-context:begin -->
## Veyr codebase graph
> Powered by Graphify · Full graph · 2026-07-22 00:28

### Architecture
3287 files, 45578 symbols in 1442 communities. Primary languages: Swift, Rust, TypeScript. Highest-impact code: .logger(), L(), tauri.ts.
